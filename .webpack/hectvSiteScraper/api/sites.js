(function(e, a) {
  ...
  \**********************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          "use strict";
          eval(
            '__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrape", function() { return scrape; });\n/* harmony import */ var _lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/helpers/response */ "./lib/helpers/response.js");\n/* harmony import */ var _lib_scraper_riverfront_times__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/scraper/riverfront_times */ "./lib/scraper/riverfront_times/index.js");\n/* harmony import */ var _lib_scraper_test_request__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/scraper/test_request */ "./lib/scraper/test_request/index.js");\n/* harmony import */ var _lib_scraper_do314__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/scraper/do314 */ "./lib/scraper/do314/index.js");\n/* harmony import */ var _lib_validation_scrapedata__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../lib/validation/scrapedata */ "./lib/validation/scrapedata/index.js");\n/* harmony import */ var _lib_store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/store */ "./lib/store/index.js");\n\n\n\n\n\n\nconst scrape = async event => {\n  /* eslint global-require: ["off"] */\n  const db = __webpack_require__(/*! ../lib/models */ "./lib/models/index.js").default;\n\n  const {\n    pathParameters: {\n      id,\n      page\n    } = {}\n  } = event;\n  let scrapeResult = [];\n\n  try {\n    await db.sequelize.authenticate();\n  } catch (err) {\n    console.log(\'Unable to connect to the database: \', err.message);\n  }\n\n  switch (id) {\n    case \'riverfronttimes\':\n      try {\n        scrapeResult = await Object(_lib_scraper_riverfront_times__WEBPACK_IMPORTED_MODULE_1__["default"])({\n          currentPage: page\n        });\n      } catch (err) {\n        return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["error"])({\n          errorMessage: `Unable to scrape the site. ${err.message}`\n        });\n      }\n\n      break;\n\n    case \'testRequest\':\n      scrapeResult = await Object(_lib_scraper_test_request__WEBPACK_IMPORTED_MODULE_2__["default"])({\n        currentPage: page\n      });\n      return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["success"])({\n        success: scrapeResult\n      });\n\n    case \'do314\':\n      try {\n        scrapeResult = await Object(_lib_scraper_do314__WEBPACK_IMPORTED_MODULE_3__["default"])({\n          currentPage: page\n        });\n      } catch (err) {\n        return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["error"])({\n          errorMessage: `Unable to scrape the site. ${err.message}`\n        });\n      }\n\n      break;\n\n    default:\n      return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["error"])({\n        errorMessage: \'The requested site is not supported.\'\n      });\n  }\n\n  try {\n    if (Object(_lib_validation_scrapedata__WEBPACK_IMPORTED_MODULE_4__["default"])(scrapeResult)) {\n      await Object(_lib_store__WEBPACK_IMPORTED_MODULE_5__["default"])({\n        db,\n        data: scrapeResult\n      });\n      return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["success"])({\n        success: `${scrapeResult.events ? scrapeResult.events.length : 0} results created`\n      });\n    }\n\n    return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["error"])({\n      errorMessage: \'Cannot validate the results.\'\n    });\n  } catch (err) {\n    return Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["error"])({\n      errorMessage: `Cannot store the results: ${err.message}`\n    });\n  }\n};\n/* harmony default export */ __webpack_exports__["default"] = (event => Object(_lib_helpers_response__WEBPACK_IMPORTED_MODULE_0__["success"])(event));\n\n//# sourceURL=webpack:///./api/sites.js?'
          );
  ...
  \************************************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          "use strict";
          eval(
            "__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var cheerio__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cheerio */ \"cheerio\");\n/* harmony import */ var cheerio__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(cheerio__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dayjs */ \"dayjs\");\n/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var request_promise__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! request-promise */ \"request-promise\");\n/* harmony import */ var request_promise__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(request_promise__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _helpers_response__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/response */ \"./lib/helpers/response.js\");\n/* harmony import */ var user_agents__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! user-agents */ \"user-agents\");\n/* harmony import */ var user_agents__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(user_agents__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\n\nconst scrape = async ({\n  limit,\n  currentPage = '2018-08-15'\n}) => {\n  const newResults = {\n    siteName: 'do314',\n    handle: 'do314',\n    uri: 'https://do314.com',\n    events: []\n  };\n  const date = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(currentPage, 'YYYY-MM-DD').format('YYYY/MM/DD');\n  const userAgent = new user_agents__WEBPACK_IMPORTED_MODULE_4___default.a();\n  const options = {\n    uri: `https://do314.com/events/${date}`,\n    headers: {\n      'User-Agent': userAgent.toString()\n    },\n    transform: body => cheerio__WEBPACK_IMPORTED_MODULE_0___default.a.load(body)\n  };\n  const $$ = await request_promise__WEBPACK_IMPORTED_MODULE_2___default()(options);\n  let $listings = $$('.ds-event-listings .ds-events-page > .ds-events-group > .ds-listing');\n\n  if (!$listings.length) {\n    return newResults;\n  }\n\n  if (limit) {\n    $listings = $listings.slice(0, limit);\n  }\n\n  await Promise.all(\n  /* eslint no-async-promise-executor: [\"off\"] */\n  $listings.toArray().map(e => new Promise(async resolve => {\n    try {\n      let href = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])(cheerio__WEBPACK_IMPORTED_MODULE_0___default()(e).find('a.ds-listing-event-title.url').attr('href'));\n\n      if (!href) {\n        throw Error(`Unable to locate href from event: ${cheerio__WEBPACK_IMPORTED_MODULE_0___default()(e).html()}`);\n      }\n\n      if (href.match(/^(http|https)/) === null) {\n        href = `https://do314.com${href}`;\n      }\n\n      const userAgent2 = new user_agents__WEBPACK_IMPORTED_MODULE_4___default.a();\n      const options = {\n        uri: href,\n        headers: {\n          'User-Agent': userAgent2.toString()\n        },\n        transform: body => cheerio__WEBPACK_IMPORTED_MODULE_0___default.a.load(body)\n      };\n      const $ = await request_promise__WEBPACK_IMPORTED_MODULE_2___default()(options);\n      let address;\n      let phone;\n      let uri;\n      let locationHref = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-meta [itemprop=location] .ds-venue-name a[itemprop=url]').attr('href'));\n\n      if (locationHref) {\n        if (locationHref.match(/^(http|https)/) === null) {\n          locationHref = `https://do314.com${locationHref}`;\n        }\n\n        const userAgent3 = new user_agents__WEBPACK_IMPORTED_MODULE_4___default.a();\n        const lOptions = {\n          uri: locationHref,\n          headers: {\n            'User-Agent': userAgent3.toString()\n          },\n          transform: body => cheerio__WEBPACK_IMPORTED_MODULE_0___default.a.load(body)\n        };\n        const l$ = await request_promise__WEBPACK_IMPORTED_MODULE_2___default()(lOptions);\n\n        if (l$) {\n          address = {\n            address1: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])(l$('.ds-detail-meta > .ds-detail-address > [itemprop=streetAddress]').attr('content')),\n            city: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])(l$('.ds-detail-meta > .ds-detail-address > [itemprop=addressLocality]').attr('content')),\n            state: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])(l$('.ds-detail-meta > .ds-detail-address > [itemprop=addressRegion]').attr('content')),\n            zip: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])(l$('.ds-detail-meta > .ds-detail-address > [itemprop=postalCode]').attr('content'))\n          };\n          phone = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])((l$('.ds-detail-meta > .ds-detail-phone > a').attr('href') || '').replace('tel:', ''));\n          uri = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])(l$('.ds-detail-meta > .ds-detail-website > a').attr('href'));\n        }\n      }\n\n      const coverImage = $('.ds-event-detail > .ds-event-detail-main .ds-cover-image');\n      let image = '';\n\n      if (coverImage) {\n        const style = coverImage.attr('style');\n        let bgImageDQ = '';\n        let bgImageSQ = '';\n\n        if (style) {\n          bgImageDQ = style.match(/background-image:.*url\\(\"([^\"]+)/);\n          bgImageSQ = style.match(/background-image:.*url\\('([^']+)/);\n        }\n\n        if (bgImageDQ && bgImageDQ.length > 1) {\n          [, image] = bgImageDQ;\n        } else if (bgImageSQ && bgImageSQ.length > 1) {\n          [, image] = bgImageSQ;\n        }\n      }\n\n      const startDate = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-detail > .ds-event-detail-main .ds-event-meta-container [itemprop=startDate]').attr('content'));\n      const endDate = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-detail > .ds-event-detail-main .ds-event-meta-container [itemprop=endDate]').attr('content'));\n      const displayDate = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-detail > .ds-event-detail-main .ds-event-meta-container .ds-event-time > span').attr('data-datetime'));\n      newResults.events.push({\n        eventName: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-detail > .ds-event-detail-main .ds-event-title-text').text()),\n        handle: href,\n        date: displayDate,\n        startDate: startDate || displayDate,\n        endDate: endDate || displayDate,\n        description: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-description-inner').text()),\n        location: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-detail > .ds-event-detail-main .ds-venue-name [itemprop=name]').text()),\n        price: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('.ds-event-detail > .ds-event-detail-main .ds-event-meta-container h2[itemprop=price]').attr('title')),\n        address,\n        phone,\n        image,\n        uri\n      });\n      resolve(newResults);\n    } catch (err) {\n      console.log('Unable to read content. ', err.message);\n      resolve(err);\n    }\n  })));\n  return newResults;\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (scrape);\n\n//# sourceURL=webpack:///./lib/scraper/do314/index.js?"
          );
  ...
  \***********************************************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          "use strict";
          eval(
            "__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var cheerio__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cheerio */ \"cheerio\");\n/* harmony import */ var cheerio__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(cheerio__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var request_promise__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! request-promise */ \"request-promise\");\n/* harmony import */ var request_promise__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(request_promise__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var user_agents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! user-agents */ \"user-agents\");\n/* harmony import */ var user_agents__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(user_agents__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _helpers_response__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/response */ \"./lib/helpers/response.js\");\n\n\n\n\n\nconst scrape = async ({\n  currentPage = 1,\n  limit\n}) => {\n  const newResults = {\n    siteName: 'Riverfront Times',\n    handle: 'riverfront_times',\n    uri: 'https://riverfronttimes.com',\n    events: []\n  };\n  const userAgent = new user_agents__WEBPACK_IMPORTED_MODULE_2___default.a();\n  const options = {\n    uri: `https://riverfronttimes.com/stlouis/EventSearch?page=${currentPage}`,\n    headers: {\n      'User-Agent': userAgent.toString()\n    },\n    transform: body => cheerio__WEBPACK_IMPORTED_MODULE_0___default.a.load(body)\n  };\n  const $$ = await request_promise__WEBPACK_IMPORTED_MODULE_1___default()(options);\n  let $listings = $$('#searchResults > .results-container > .EventListing');\n\n  if (!$listings.length) {\n    return newResults;\n  }\n\n  if (limit) {\n    $listings = $listings.slice(0, limit);\n  }\n\n  await Promise.all(\n  /* eslint no-async-promise-executor: [\"off\"] */\n  $listings.toArray().map(e => new Promise(async resolve => {\n    const $$ = cheerio__WEBPACK_IMPORTED_MODULE_0___default()(e);\n    const href = $$.find('> .listing > h3 > a').attr('href');\n    const imgTag = $$.find('> .imageTools > .listingImage > img').attr('src');\n    let image = '';\n\n    if (!href) {\n      throw Error(`Unable to locate href from event: ${$$.html()}`);\n    }\n\n    if (imgTag) {\n      image = imgTag;\n    }\n\n    try {\n      const TEXT_NODE_TYPE = 3;\n      const userAgent2 = new user_agents__WEBPACK_IMPORTED_MODULE_2___default.a();\n      const pageOptions = {\n        uri: href,\n        headers: {\n          'User-Agent': userAgent2.toString()\n        },\n        transform: body => cheerio__WEBPACK_IMPORTED_MODULE_0___default.a.load(body)\n      };\n      const $ = await request_promise__WEBPACK_IMPORTED_MODULE_1___default()(pageOptions);\n      const date = Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventMetaData > .eventWhen').contents().filter((idx, el) => el.nodeType === TEXT_NODE_TYPE).text());\n      newResults.events.push({\n        eventName: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventMetaData > .EventDetails > .listingTitle').contents().filter((idx, el) => el.nodeType === TEXT_NODE_TYPE).text()),\n        handle: href,\n        uri: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > li > .locationUrl > a').attr('href')),\n        price: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventMetaData > .eventPrice').contents().filter((idx, el) => el.nodeType === TEXT_NODE_TYPE).text()),\n        description: (() => {\n          const $descr = $('#EventDescription > .descr_txt');\n          $descr.contents().filter((idx, el) => el.attribs && el.attribs.class === 'author_txt').remove();\n          return Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($descr.html());\n        })(),\n        location: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > h4 > a').text()),\n        address: {\n          address1: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > .adr > .street-address').text()),\n          address2: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > .adr > .extended-address').text()),\n          city: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > .adr > span > .locality').text()),\n          state: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > .adr > .region').text()),\n          zip: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > .adr .postal-address').text())\n        },\n        phone: Object(_helpers_response__WEBPACK_IMPORTED_MODULE_3__[\"clean\"])($('#EventLocation > ul > .locationItem > ul > li > .locationPhone > .value').text()),\n        image,\n        startDate: date,\n        endDate: date,\n        date\n      });\n      resolve(true);\n    } catch (err) {\n      console.log('Unable to read content. ', err.message);\n      resolve(err);\n    }\n  })));\n  return newResults;\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (scrape);\n\n//# sourceURL=webpack:///./lib/scraper/riverfront_times/index.js?"
          );
